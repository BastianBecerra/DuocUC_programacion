...
cantidad_gusanos = float(input("Ingrese la cantidad de gusanos: "))
...
"""
if (color_de_uva == "celeste") and (peso >= 13) and (radio != 10) and (densidad < 3) and (3 <= cantidad_gusanos <= 5):
     puedes_sacar_la_uva = "Si"

"""
Arreglo en errores del anterior codigo.
"""
